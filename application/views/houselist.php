...
<body>
	...
	<nav class="nav1">
		...
		<a href="<?php echo site_url('sell/sells')?>">买房</a>
	</nav>

<div class="list-search" >
	<input type="text" class="list-input"  name="text1" placeholder="请输入小区或商圈名称"  />
	<a href="javascript:void(0);" class="search-btn"><img src="img/list-search.png"/></a>
</div>
<!--二手房搜索-->
<div class="search-none" style="display:none;">
	<div class="search-top">
	  <a href="javascript:void(0);" class="table-cell" id="return"><img src="img/return1.png"></a>
	  <div class="table-cell" style="width: 100%;">
	     <input class="none-input" type="text" id="accounts" name="text1" placeholder="请输入小区或商圈名称" />
	  </div>
	  <a href="javascript:void(0);" class="table-cell"><img src="img/search1.png" style="margin-left: 4px;"></a>
	</div>
</div><!--二手房搜索-->
...
<div class="more-eject more-height">
    ...
    <div style="background: #ff5a60; padding:0.938rem; color:#fff; position:absolute; bottom:0px; text-align:center; z-index:999; width:100%;"><a href="javascript:void(0);" style="color:#fff" id="search">确定</a></div>
	...
	<ul class="house-list">
		...
		<li>
			<a href="sell/selldetail/<?php echo $v->SELL_id?>">
				...
				<p class="house-type"><?php echo $v->SELL_type?></p>
